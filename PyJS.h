...
#define PYJS_RETURN_VAR					"return"
#define PYJS_LOKALE_VAR					"__locale__"
#define PYJS_ANONYMOUS_VAR				"__anonymous__"
#define PYJS_ARGUMENTS_VAR				"arguments"
#define PYJS___PROTO___VAR				"__proto__"
#define PYJS_PROTOTYPE_CLASS			"prototype"
#define PYJS_FUNCTION_CLOSURE_VAR		"__function_closure__"
#define PYJS_SCOPE_PARENT_VAR			"__scope_parent__"
#define PYJS_SCOPE_WITH_VAR				"__scope_with__"
#define PYJS_ACCESSOR_GET_VAR			"__accessor_get__"
#define PYJS_ACCESSOR_SET_VAR			"__accessor_set__"
#define PYJS_CONSTRUCTOR_VAR			"constructor"
#define PYJS_TEMP_NAME			""
#define PYJS_BLANK_DATA			""
...
protected:
	CScriptVar(CPyJS *Context, const CScriptVarPtr &Prototype); ///< Create
...
#define getParsableStringRecursionsCheck() do{		\
	...
	CPyJS *getContext() { return context; }
...
private: // prevent gloabal creating
	CScriptVarLink(const CScriptVarPtr &var, const std::string &name = PYJS_TEMP_NAME, int flags = SCRIPTVARLINK_DEFAULT);
...
public: 
	...
	CScriptVarLinkPtr(const CScriptVarPtr &var, const std::string &name = PYJS_TEMP_NAME, int flags = SCRIPTVARLINK_DEFAULT) { link=(new CScriptVarLink(var, name, flags))->ref(); }
	CScriptVarLinkPtr(CScriptVarLink *Link) : link(Link) { if(link) link->ref(); } // creates a new CScriptVarLink (from new);

	// reconstruct
	CScriptVarLinkPtr &operator()(const CScriptVarPtr &var, const std::string &name = PYJS_TEMP_NAME, int flags = SCRIPTVARLINK_DEFAULT);
...
public:
	// construct
	CScriptVarLinkWorkPtr() {}
	CScriptVarLinkWorkPtr(const CScriptVarPtr &var, const std::string &name = PYJS_TEMP_NAME, int flags = SCRIPTVARLINK_DEFAULT) : CScriptVarLinkPtr(var, name, flags) {}
	...
	// reconstruct
	CScriptVarLinkWorkPtr &operator()(const CScriptVarPtr &var, const std::string &name = PYJS_TEMP_NAME, int flags = SCRIPTVARLINK_DEFAULT) {CScriptVarLinkPtr::operator()(var, name, flags); referencedOwner.clear(); return *this; }
...
protected:
	CScriptVarPrimitive(CPyJS *Context, const CScriptVarPtr &Prototype) : CScriptVar(Context, Prototype) { setExtensible(false); }
...
protected:
	CScriptVarUndefined(CPyJS *Context);
...
public:
	...
	friend define_DEPRECATED_newScriptVar_Fnc(Undefined, CPyJS *, Undefined_t);
	friend define_newScriptVar_NamedFnc(Undefined, CPyJS *Context);
};
inline define_DEPRECATED_newScriptVar_Fnc(Undefined, CPyJS *Context, Undefined_t) { return new CScriptVarUndefined(Context); }
inline define_newScriptVar_NamedFnc(Undefined, CPyJS *Context) { return new CScriptVarUndefined(Context); }
...
public:
	...
	friend define_DEPRECATED_newScriptVar_Fnc(Null, CPyJS *Context, Null_t);
	friend define_newScriptVar_NamedFnc(Null, CPyJS *Context);
};
inline define_DEPRECATED_newScriptVar_Fnc(Null, CPyJS *Context, Null_t) { return new CScriptVarNull(Context); }
inline define_newScriptVar_NamedFnc(Null, CPyJS *Context) { return new CScriptVarNull(Context); }
...
protected:
	CScriptVarString(CPyJS *Context, const std::string &Data);
...
protected:
	std::string data;
private:
	friend define_newScriptVar_Fnc(String, CPyJS *Context, const std::string &);
	friend define_newScriptVar_Fnc(String, CPyJS *Context, const char *);
	friend define_newScriptVar_Fnc(String, CPyJS *Context, char *);
};
inline define_newScriptVar_Fnc(String, CPyJS *Context, const std::string &Obj) { return new CScriptVarString(Context, Obj); }
inline define_newScriptVar_Fnc(String, CPyJS *Context, const char *Obj) { return new CScriptVarString(Context, Obj); }
inline define_newScriptVar_Fnc(String, CPyJS *Context, char *Obj) { return new CScriptVarString(Context, Obj); }
...
protected:
	CScriptVarNumber(CPyJS *Context, const CNumber &Data);
...
private:
	CNumber data;
	friend define_newScriptVar_Fnc(Number, CPyJS *Context, const CNumber &);
	friend define_newScriptVar_NamedFnc(Number, CPyJS *Context, const CNumber &);
};
define_newScriptVar_Fnc(Number, CPyJS *Context, const CNumber &Obj);
inline define_newScriptVar_NamedFnc(Number, CPyJS *Context, const CNumber &Obj) { return new CScriptVarNumber(Context, Obj); }
inline define_newScriptVar_Fnc(Number, CPyJS *Context, unsigned int Obj) { return newScriptVarNumber(Context, CNumber(Obj)); }
inline define_newScriptVar_Fnc(Number, CPyJS *Context, unsigned long Obj) { return newScriptVarNumber(Context, CNumber((uint32_t)Obj)); }
inline define_newScriptVar_Fnc(Number, CPyJS *Context, int Obj) { return newScriptVarNumber(Context, CNumber(Obj)); }
inline define_newScriptVar_Fnc(Number, CPyJS *Context, long Obj) { return newScriptVarNumber(Context, CNumber((int32_t)Obj)); }
inline define_newScriptVar_Fnc(Number, CPyJS *Context, double Obj) { return newScriptVarNumber(Context, CNumber(Obj)); }
inline define_DEPRECATED_newScriptVar_Fnc(NaN, CPyJS *Context, NaN_t) { return newScriptVarNumber(Context, CNumber(NaN)); }
inline define_DEPRECATED_newScriptVar_Fnc(Infinity, CPyJS *Context, Infinity Obj) { return newScriptVarNumber(Context, CNumber(Obj)); } 
...
protected:
	CScriptVarBool(CPyJS *Context, bool Data);
...
protected:
	...
	friend define_DEPRECATED_newScriptVar_Fnc(Bool, CPyJS *, bool);
	friend define_newScriptVar_NamedFnc(Bool, CPyJS *Context, bool);
};
inline define_DEPRECATED_newScriptVar_Fnc(Bool, CPyJS *Context, bool Obj) { return new CScriptVarBool(Context, Obj); }
inline define_newScriptVar_NamedFnc(Bool, CPyJS *Context, bool Obj) { return new CScriptVarBool(Context, Obj); }
...
protected:
	CScriptVarObject(CPyJS *Context);
	CScriptVarObject(CPyJS *Context, const CScriptVarPtr &Prototype) : CScriptVar(Context, Prototype) {}
	CScriptVarObject(CPyJS *Context, const CScriptVarPrimitivePtr &Value, const CScriptVarPtr &Prototype) : CScriptVar(Context, Prototype), value(Value) {}
...
private:
	...
	friend define_newScriptVar_Fnc(Object, CPyJS *Context, Object_t);
	friend define_newScriptVar_Fnc(Object, CPyJS *Context, Object_t, const CScriptVarPtr &);
	friend define_newScriptVar_Fnc(Object, CPyJS *Context, const CScriptVarPtr &);
	friend define_newScriptVar_Fnc(Object, CPyJS *Context, const CScriptVarPrimitivePtr &, const CScriptVarPtr &);
};
inline define_newScriptVar_Fnc(Object, CPyJS *Context, Object_t) { return new CScriptVarObject(Context); }
inline define_newScriptVar_Fnc(Object, CPyJS *Context, Object_t, const CScriptVarPtr &Prototype) { return new CScriptVarObject(Context, Prototype); }
inline define_newScriptVar_Fnc(Object, CPyJS *Context, const CScriptVarPtr &Prototype) { return new CScriptVarObject(Context, Prototype); }
inline define_newScriptVar_Fnc(Object, CPyJS *Context, const CScriptVarPrimitivePtr &Value, const CScriptVarPtr &Prototype) { return new CScriptVarObject(Context, Value, Prototype); }
...
protected:
//	CScriptVarObjectTyped(CPyJS *Context);
	CScriptVarObjectTypeTagged(CPyJS *Context, const CScriptVarPtr &Prototype, const std::string &TypeTagName) : CScriptVarObject(Context, Prototype), typeTagName(TypeTagName) {}
...
private:
	...
	friend define_newScriptVar_Fnc(Object, CPyJS *Context, Object_t, const CScriptVarPtr &, const std::string &);
	friend define_newScriptVar_Fnc(Object, CPyJS *Context, const CScriptVarPtr &, const std::string &);
};
inline define_newScriptVar_Fnc(Object, CPyJS *Context, Object_t, const CScriptVarPtr &Prototype, const std::string &TypeTagName) { return new CScriptVarObjectTypeTagged(Context, Prototype, TypeTagName); }
inline define_newScriptVar_Fnc(Object, CPyJS *Context, const CScriptVarPtr &Prototype, const std::string &TypeTagName) { return new CScriptVarObjectTypeTagged(Context, Prototype, TypeTagName); }
...
protected:
	CScriptVarError(CPyJS *Context, ERROR_TYPES type, const char *message, const char *file, int line, int column);// : CScriptVarObject(Context), value(Value) {}
...
private:
	friend define_newScriptVar_NamedFnc(Error, CPyJS *Context, ERROR_TYPES type, const char *message, const char *file, int line, int column);
	friend define_newScriptVar_NamedFnc(Error, CPyJS *Context, const CScriptException &Exception);
};
inline define_newScriptVar_NamedFnc(Error, CPyJS *Context, ERROR_TYPES type, const char *message=0, const char *file=0, int line=-1, int column=-1) { return new CScriptVarError(Context, type, message, file, line, column); }
inline define_newScriptVar_NamedFnc(Error, CPyJS *Context, const CScriptException &Exception) { return new CScriptVarError(Context, Exception.errorType, Exception.message.c_str(), Exception.fileName.c_str(), Exception.lineNumber, Exception.column); }
...
public:
	...
	friend define_newScriptVar_Fnc(Array, CPyJS *Context, Array_t);
private:
	void native_Length(const CFunctionsScopePtr &c, void *data);
	bool toStringRecursion;
};
inline define_newScriptVar_Fnc(Array, CPyJS *Context, Array_t) { return new CScriptVarArray(Context); } 
...
protected:
	CScriptVarRegExp(CPyJS *Context, const std::string &Source, const std::string &Flags);
...
private:
	...
	friend define_newScriptVar_Fnc(RegExp, CPyJS *Context, const std::string &, const std::string &);

};
inline define_newScriptVar_Fnc(RegExp, CPyJS *Context, const std::string &Obj, const std::string &Flags) { return new CScriptVarRegExp(Context, Obj, Flags); }
...
protected:
	CScriptVarFunction(CPyJS *Context, CScriptTokenDataFnc *Data);
...
private:
	...
	friend define_newScriptVar_Fnc(Function, CPyJS *Context, CScriptTokenDataFnc *);
};
inline define_newScriptVar_Fnc(Function, CPyJS *Context, CScriptTokenDataFnc *Obj) { return new CScriptVarFunction(Context, Obj); }
...
protected:
	CScriptVarFunctionNative(CPyJS *Context, void *Userdata, const char *Name) : CScriptVarFunction(Context, new CScriptTokenDataFnc), jsUserData(Userdata) {
...
protected:
	CScriptVarFunctionNativeCallback(CPyJS *Context, JSCallback Callback, void *Userdata, const char *Name) : CScriptVarFunctionNative(Context, Userdata, Name), jsCallback(Callback) { }
...
private:
	...
	friend define_newScriptVar_Fnc(FunctionNativeCallback, CPyJS *Context, JSCallback Callback, void*, const char*);
};
inline define_newScriptVar_Fnc(FunctionNativeCallback, CPyJS *Context, JSCallback Callback, void *Userdata, const char *Name=0) { return new CScriptVarFunctionNativeCallback(Context, Callback, Userdata, Name); }
...
protected:
	CScriptVarFunctionNativeClass(CPyJS *Context, native *ClassPtr, void (native::*ClassFnc)(const CFunctionsScopePtr &, void *), void *Userdata, const char *Name) : CScriptVarFunctionNative(Context, Userdata, Name), classPtr(ClassPtr), classFnc(ClassFnc) { }
...
private:
	...
	friend define_newScriptVar_Fnc(FunctionNativeCallback, CPyJS*, native2 *, void (native2::*)(const CFunctionsScopePtr &, void *), void *, const char *);
};
template<typename native>
define_newScriptVar_Fnc(FunctionNativeCallback, CPyJS *Context, native *ClassPtr, void (native::*ClassFnc)(const CFunctionsScopePtr &, void *), void *Userdata, const char *Name=0) { return new CScriptVarFunctionNativeClass<native>(Context, ClassPtr, ClassFnc, Userdata, Name); }
...
protected:
	CScriptVarAccessor(CPyJS *Context);
	CScriptVarAccessor(CPyJS *Context, JSCallback getter, void *getterdata, JSCallback setter, void *setterdata);
	template<class C>	CScriptVarAccessor(CPyJS *Context, C *class_ptr, void(C::*getterFnc)(const CFunctionsScopePtr &, void *), void *getterData, void(C::*setterFnc)(const CFunctionsScopePtr &, void *), void *setterData) : CScriptVarObject(Context) {
		if(getterFnc)
			addChild(PYJS_ACCESSOR_GET_VAR, ::newScriptVar(Context, class_ptr, getterFnc, getterData), 0);
		if(setterFnc)
			addChild(PYJS_ACCESSOR_SET_VAR, ::newScriptVar(Context, class_ptr, setterFnc, setterData), 0);
	}
	CScriptVarAccessor(CPyJS *Context, const CScriptVarFunctionPtr &getter, const CScriptVarFunctionPtr &setter);
...
public:
	...
	friend define_newScriptVar_Fnc(Accessor, CPyJS *Context, Accessor_t);
	friend define_newScriptVar_NamedFnc(Accessor, CPyJS *Context, JSCallback getter, void *getterdata, JSCallback setter, void *setterdata);
	template<class C> friend define_newScriptVar_NamedFnc(Accessor, CPyJS *Context, C *class_ptr, void(C::*getterFnc)(const CFunctionsScopePtr &, void *), void *getterData, void(C::*setterFnc)(const CFunctionsScopePtr &, void *), void *setterData);
	friend define_newScriptVar_NamedFnc(Accessor, CPyJS *Context, const CScriptVarFunctionPtr &, const CScriptVarFunctionPtr &);
};
inline define_newScriptVar_Fnc(Accessor, CPyJS *Context, Accessor_t) { return new CScriptVarAccessor(Context); }
inline define_newScriptVar_NamedFnc(Accessor, CPyJS *Context, JSCallback getter, void *getterdata, JSCallback setter, void *setterdata) { return new CScriptVarAccessor(Context, getter, getterdata, setter, setterdata); }
template<class C> define_newScriptVar_NamedFnc(Accessor, CPyJS *Context, C *class_ptr, void(C::*getterFnc)(const CFunctionsScopePtr &, void *), void *getterData, void(C::*setterFnc)(const CFunctionsScopePtr &, void *), void *setterData)  { return new CScriptVarAccessor(Context, class_ptr, getterFnc, getterData, setterFnc, setterData); }
inline define_newScriptVar_NamedFnc(Accessor, CPyJS *Context, const CScriptVarFunctionPtr &getter, const CScriptVarFunctionPtr &setter) { return new CScriptVarAccessor(Context, getter, setter); }
...
protected: // only derived classes or friends can be created
	CScriptVarDestructuring(CPyJS *Context) // constructor for rootScope
...
protected: // only derived classes or friends can be created
	CScriptVarScope(CPyJS *Context) // constructor for rootScope
		: CScriptVarObject(Context) {}
	virtual CScriptVarPtr clone();
...
public:
	...
	friend define_newScriptVar_Fnc(Scope, CPyJS *Context, Scope_t);
};
inline define_newScriptVar_Fnc(Scope, CPyJS *Context, Scope_t) { return new CScriptVarScope(Context); }
...
protected: // only derived classes or friends can be created
	CScriptVarScopeFnc(CPyJS *Context, const CScriptVarScopePtr &Closure) // constructor for FncScope
		: CScriptVarScope(Context), closure(Closure ? addChild(PYJS_FUNCTION_CLOSURE_VAR, Closure, 0) : CScriptVarLinkPtr()) {}
public:
...
protected:
	...
	friend define_newScriptVar_Fnc(ScopeFnc, CPyJS *Context, ScopeFnc_t, const CScriptVarScopePtr &Closure);
};
inline define_newScriptVar_Fnc(ScopeFnc, CPyJS *Context, ScopeFnc_t, const CScriptVarScopePtr &Closure) { return new CScriptVarScopeFnc(Context, Closure); }
...
//		: CScriptVarScope(Parent->getContext()), parent( context->getRoot() != Parent ? addChild(PYJS_SCOPE_PARENT_VAR, Parent, 0) : 0) {}
public:
...
protected:
	...
	friend define_newScriptVar_Fnc(ScopeLet, CPyJS *Context, ScopeLet_t, const CScriptVarScopePtr &Parent);
};
inline define_newScriptVar_Fnc(ScopeLet, CPyJS *, ScopeLet_t, const CScriptVarScopePtr &Parent) { return new CScriptVarScopeLet(Parent); }
...
protected:
	CScriptVarScopeWith(const CScriptVarScopePtr &Parent, const CScriptVarPtr &With) 
		: CScriptVarScopeLet(Parent), with(addChild(PYJS_SCOPE_WITH_VAR, With, 0)) {}
...
private:
	...
	friend define_newScriptVar_Fnc(ScopeWith, CPyJS *Context, ScopeWith_t, const CScriptVarScopePtr &Parent, const CScriptVarPtr &With);
};
inline define_newScriptVar_Fnc(ScopeWith, CPyJS *, ScopeWith_t, const CScriptVarScopePtr &Parent, const CScriptVarPtr &With) { return new CScriptVarScopeWith(Parent, With); }
...
protected:
	CScriptVarDefaultIterator(CPyJS *Context, const CScriptVarPtr &Object, int Mode);
...
private:
	...
	STRING_SET_t keys;
	STRING_SET_it pos;
	friend define_newScriptVar_NamedFnc(DefaultIterator, CPyJS *, const CScriptVarPtr &, int);

};
inline define_newScriptVar_NamedFnc(DefaultIterator, CPyJS *Context, const CScriptVarPtr &Object, int Mode) { return new CScriptVarDefaultIterator(Context, Object, Mode); }
...
protected:
	CScriptVarGenerator(CPyJS *Context, const CScriptVarPtr &FunctionRoot, const CScriptVarFunctionPtr &Function);
...
public:
	...
	friend define_newScriptVar_NamedFnc(CScriptVarGenerator, CPyJS *, const CScriptVarPtr &, const CScriptVarFunctionPtr &);

};
inline define_newScriptVar_NamedFnc(CScriptVarGenerator, CPyJS *Context, const CScriptVarPtr &FunctionRoot, const CScriptVarFunctionPtr &Function) { return new CScriptVarGenerator(Context, FunctionRoot, Function); }
...
public:
	...
	/// add a native function to be called from PYJS
	/** example:
		\code
			void scRandInt(const CFunctionsScopePtr &c, void *userdata) { ... }
			PYJS->addNative("function randInt(min, max)", scRandInt, 0);
		\endcode
		...
		\code
			...
			PYJS->addNative("function String.substring(lo, hi)", scSubstring, 0);
		\endcode
		or
		...
		\code
			...
			Class Instanz;
			PYJS->addNative("function String.substring(lo, hi)", &Instanz, &Class::*scSubstring, 0);
		\endcode
	*/
...
private:
	...
	public:
		CScopeControl(CPyJS *Context) : context(Context), count(0) {} 
